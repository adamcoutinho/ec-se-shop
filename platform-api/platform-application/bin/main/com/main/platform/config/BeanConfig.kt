...
class BeanConfig {
    ...
    @Bean
    fun registerCustomerController(registerCustomerPort: RegisterCustomerPort): RegisterCustomerController =
        RegisterCustomerControllerImpl(registerCustomerPort)
