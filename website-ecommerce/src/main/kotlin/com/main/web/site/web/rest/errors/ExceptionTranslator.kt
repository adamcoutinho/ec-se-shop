package com.main.web.site.web.rest.errors
...
class ExceptionTranslator(private val env: Environment) : ProblemHandling, SecurityAdviceTrait {
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.main.web.site").any { it == message }
}
